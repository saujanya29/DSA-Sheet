...
// This question Completes in 3 steps 
/*

Step 1 -> Detect cylce in Linked List 
Step 2 -> Get Starting Node Of loop in Linked List
Step 3 -> Remove Cycle From Linked List 

*/ 

// Step 1 -> Detect cylce in Linked List  
// Two Methods to Implement this  - 1.Using Maps 2. Floyd Detection Algorithms
...
Node * GetStartingNode ( Node * Head){
    Node * IntersectionNode = FloydCycleDetection(Head);
