...
// this will give the left middle of list with even nodes and middle of the odd Nodes 
...
/*
 this will give the right middle  of the list  with even nodes 
while(Fast != NULL ){
...
int main(){
    ...
    Node * ans = MidLL1(Head);
    cout<<"middle LL :"<<ans->data<<endl;
